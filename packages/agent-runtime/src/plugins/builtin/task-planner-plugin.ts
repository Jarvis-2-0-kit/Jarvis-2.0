    ...
    register: (api) => {
              ...
              steps: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    assignedAgent: {
                      type: 'string',
                      description: 'Agent to delegate to (e.g., "agent-alpha", "agent-beta"). Leave empty for self.',
                    },
                  },
      ...
      api.registerTool({
        definition: {
          ...
          description: [
            ...
            '',
            'Agents:',
            '  - agent-alpha (Dev): code, build, deploy, testing, react-native',
            '  - agent-beta (Marketing): research, content, social-media, analytics',
            '',
      ...
      api.registerPromptSection({
        ...
        content: [
          ...
          '- Delegate research to agent-beta, code/build to agent-alpha',
          ...
          '```',
          'Step 1: Research (agent-beta) → deps: []',
          'Step 2: Architecture (agent-alpha) → deps: [step-1]',
          'Step 3: Implementation (agent-alpha) → deps: [step-2]',
          'Step 4: Marketing prep (agent-beta) → deps: [step-1]  ← parallel!',
          'Step 5: Testing (agent-alpha) → deps: [step-3]',
