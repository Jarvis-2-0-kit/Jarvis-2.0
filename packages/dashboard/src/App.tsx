...
const MarketingView = lazy(() => import('./views/MarketingView.js').then((m) => ({ default: m.MarketingView })));
...
// First-run redirect is handled by JarvisApp.swift (loads /setup if no SSH key).
// No React-level redirect guard — it caused race conditions on app launch.
